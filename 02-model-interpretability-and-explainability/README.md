# Отчет по Лабораторной работе №2: Model Interpretability and Explainability
...
- **Идеи о глобальной интерпретации вы изучили:**
...
- **Совпадения и различия объяснения двух моделей:**
...
### Что изучено по ходу выполнения
- **Изучено о связи между raw-признаком и mean score:**
...
### Согласованность глобальных объяснений
