# Отчет по Лабораторной работе №1: Feature Importance and Selection

Оценивание выполняется по единому rubric: `../RUBRIC_TEMPLATE.md`.


## Контекст
- ФИО автора работы: Степанова Анна Андреевна
- Группа: 1.2
...
## Сравнение методов значимости признаков
...
## Влияние отбора признаков на качество моделей
...
- **Наиболее показательные сравнения:**
...
## Обязательные самостоятельные задания

### Методическое изучение по ходу самостоятельных заданий
...
- **Минимум одно сравнение подходов в каждом подпункте:**
  ...
  - Сравнила RFE и L1-регуляризацию по стабильности: RFE оказался более стабильным при изменении random_state.
...
### Устойчивость filter-ранжирования
...
### Согласованность wrapper/embedded методов
...
### Порог, CV и сегментный анализ ошибок
